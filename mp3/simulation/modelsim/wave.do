...
add wave -noupdate /mp0_tb/pmem_resp
...
add wave -noupdate -radix hexadecimal /mp0_tb/pmem_wdata
add wave -noupdate -radix hexadecimal /mp0_tb/pmem_address
add wave -noupdate -radix hexadecimal -childformat {{/mp0_tb/dut/F/if_id.intr -radix hexadecimal} {/mp0_tb/dut/F/if_id.pc_out -radix hexadecimal}} -expand -subitemconfig {/mp0_tb/dut/F/if_id.intr {-radix hexadecimal} /mp0_tb/dut/F/if_id.pc_out {-radix hexadecimal}} /mp0_tb/dut/F/if_id
...
WaveRestoreCursors {{Cursor 1} {1005000 ps} 0}
...
update
WaveRestoreZoom {472751 ps} {1472751 ps}
