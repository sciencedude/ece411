...
add wave -noupdate -radix hexadecimal -childformat {{/mp0_tb/dut/F/if_id.intr -radix hexadecimal} {/mp0_tb/dut/F/if_id.pc_out -radix hexadecimal} {/mp0_tb/dut/F/if_id.brpredict -radix hexadecimal}} -expand -subitemconfig {/mp0_tb/dut/F/if_id.intr {-height 16 -radix hexadecimal} /mp0_tb/dut/F/if_id.pc_out {-height 16 -radix hexadecimal} /mp0_tb/dut/F/if_id.brpredict {-height 16 -radix hexadecimal}} /mp0_tb/dut/F/if_id
add wave -noupdate -radix hexadecimal /mp0_tb/dut/D_cache/mem_address
add wave -noupdate -radix hexadecimal -childformat {{/mp0_tb/dut/E/ex_mem_out.control_signals -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.pc_out -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.alu_out -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.srcb_out -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.intr -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.destreg -radix hexadecimal} {/mp0_tb/dut/E/ex_mem_out.brpredict -radix hexadecimal}} -expand -subitemconfig {/mp0_tb/dut/E/ex_mem_out.control_signals {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.pc_out {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.alu_out {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.srcb_out {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.intr {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.destreg {-height 16 -radix hexadecimal} /mp0_tb/dut/E/ex_mem_out.brpredict {-height 16 -radix hexadecimal}} /mp0_tb/dut/E/ex_mem_out
...
add wave -noupdate /mp0_tb/dut/nop_control
add wave -noupdate -expand /mp0_tb/dut/nop_ex_mem
add wave -noupdate /mp0_tb/dut/nop_id_ex
add wave -noupdate /mp0_tb/dut/nop_if_id
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {79222716 ps} 0}
...
update
WaveRestoreZoom {79027216 ps} {80051200 ps}
